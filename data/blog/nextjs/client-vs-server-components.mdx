...
images: ['/static/images/nextjs/nextjs-client-vs-server.png']  
authors: ['default']
layout: PostLayout
canonicalUrl: https://blog.codewithsloba.com/blog/nextjs/client-vs-server-components
---
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/2rk0WpbyxuI?si=FtPqGbdr1poSyLoJ" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
***
...
* [What Are Client Components?](#what-are-client-components)
* [Client Components Example](#client-components-example)
* [What Are Server Components?](#what-are-server-components)
* [Blending Client and Server Components for Optimal Performance](#blending-client-and-server-components-for-optimal-performance)
  * [Static Generation with Server Components](#static-generation-with-server-components)
  * [Dynamic Interactivity with Client Components](#dynamic-interactivity-with-client-components)
